...
>see the documentation for [Monolog 2.x](https://github.com/nholuongut/monolog/blob/2.x/README.md) or [Monolog 1.x](https://github.com/nholuongut/monolog/blob/1.x/README.md)
...
[listed in the wiki](https://github.com/nholuongut/monolog/wiki/Third-Party-Packages). You
...
Bugs and feature request are tracked on [GitHub](https://github.com/nholuongut/monolog/issues)
